      ...
      <section className="text-center px-6 pt-24 pb-16">
        <div className="max-w-3xl mx-auto">
          <img
            src="/utomlogo.png"
            alt="Utom"
            className="h-12 mx-auto mb-6 opacity-75"
          />

          <h1 className="text-3xl md:text-4xl font-bold leading-tight max-w-[700px] mx-auto">
          ...
          <button
            className="
              ...
              hover:scale-105 shadow-lg shadow-emerald-400/30
            "
          >
      ...
      <section className="px-6 py-16">
        <div className="max-w-6xl mx-auto flex flex-wrap justify-center gap-6">
          ...
          >
            ...
            <p className="mt-4 opacity-70">Rugalmas, bármikor lemondható</p>

            <button
              className="
                mt-6 w-full py-3 rounded-full font-semibold
                bg-gradient-to-r from-cyan-400 to-emerald-400
                text-slate-900 transition-all hover:scale-105
              "
            >
              Előfizetek
            </button>
          ...
          <div
            className="
              relative w-[280px] rounded-3xl p-10
              backdrop-blur-xl bg-white/5 border border-cyan-400
          ...
          >
            ...
            <p className="mt-4 opacity-70">2 hónap ajándék</p>
          ...
          <div
            ...
            "
          >
            <div className="text-2xl font-bold">🏢 Cégeknek</div>
            ...
            {[
              {
                icon: "🧬",
                title: "Forrás DNS",
                desc: "AI-alapú tartalmi ujjlenyomat, amely feltárja egy hírportál szerkezetét és mintázatait.",
              },
              {
                icon: "🧠",
                title: "Fake Detektor",
                desc: "Kiszűrjük a hamis, félrevezető vagy manipulált tartalmakat — torzítás nélkül.",
              },
              {
                icon: "🧊",
                title: "Clickbait Detektor",
                desc: "Megmutatjuk, mennyire kattintásvadász egy cím — objektív pontszámmal.",
              },
              {
                icon: "🧱",
                title: "Cikk Összehasonlítás",
                desc: "Egy témáról több forrás nézete egy helyen — az eltérések kiemelve.",
              },
              {
                icon: "🧭",
                title: "Forrás-Radar",
                desc: "Láthatod, mely portálok dominálnak egy témában — és kik maradnak csendben.",
              },
              {
                icon: "💬",
                title: "Prémium Chat Szoba",
                desc: "Exkluzív közösség, ahol elemzünk, vitázunk és együtt gondolkodunk.",
              },
              {
                icon: "🧑‍⚖️",
                title: "Közösségi Vélemény",
                desc: "Valódi felhasználói visszajelzések egy cikk megbízhatóságáról.",
              },
              {
                icon: "🧘‍♂️",
                title: "Ultra-minimalista mód",
                desc: "Csak a lényeg — reklám és zavaró elemek nélkül.",
              },
            ].map((item, i) => (
              <div
                key={i}
