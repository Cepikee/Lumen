...
export default function WSentimentTimeline() {
  ...
  const options: ApexCharts.ApexOptions = {
    chart: { type: "line", toolbar: { show: false }, foreColor: isDark ? "#fff" : "#000" },
    ...
    <>
      ...
      <UtomModal show={openInfo} onClose={() => setOpenInfo(false)} title="Mit mutat ez a grafikon?">
        <div className="text-sm leading-relaxed">
          <p>Óránként mutatja, hogy mennyi pozitív és negatív hangulatú cikk jelent meg.</p>
          <p className="mt-2">Ez segít látni, mikor romlik vagy javul a hírek hangulata.</p>
        </div>
      </UtomModal>
    </>
  );
