...
export default function UtomDns() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#071226] text-white p-6">
      {/* Egyszerű, dobozmentes layout: két oszlop — bal: chart, jobb: részletes profil + selector */}
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8">
        ...
        {/* JOBB: Részletes profil (domain választó a tetején) */}
        <aside className="w-full lg:w-96 flex flex-col gap-4">
          {/* Domain választó — a profil tetején */}
          ...
          {/* Részletes profil helye — ide később jönnek az adatok */}
          <div className="flex flex-col gap-2">
            <h3 className="text-lg font-semibold">Részletes profil</h3>
            <div className="text-sm text-slate-300">
              Itt jelennek meg a domainhez tartozó részletes információk (összes cikk, aktív időszak, stb.).
            </div>
            {/* Placeholder mezők — később API-ból töltjük */}
